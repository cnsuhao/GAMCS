 ...
 */
void CSIAgent::MergeStateInfo(const struct State_Info_Header *stif)
{
...
IAgent::State CSIAgent::NextStateToSend(int neb)
{

    IAgent::State st_send = INVALID_STATE;
