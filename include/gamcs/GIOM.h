...
class GIOM
{
    public:
        ...
        /** Default destructor */
        virtual ~GIOM();
        Output process(Input input, OSpace &available_outputs); /**< generate an output from a output space under a specified input */
        float singleOutputEntropy(Input input, OSpace &available_outputs) const; /**< calculate the entropy of a specified input */
        virtual void update(); /**< update inner states of GIOM, derived classes may have their own stuff to be updated */
 ...
 * For a single output, the end is equal to start.
 */
struct OFragment
{
        GIOM::Output start; /**< the starting output */
        GIOM::Output end; /**< the end output */
...
class OSpace
{
    public:
        ...
        /**
         * Override operator [].
         * For index that is out of bound, returns INVALID_OUTPUT
